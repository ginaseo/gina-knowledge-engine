...
def evaluate() -> dict:
    ...
    result = {
        ...
        "growth": growth,
        "quality": {
            "entity_coverage": quality.entity_coverage,
            "keyword_coverage": quality.keyword_coverage,
            "relation_coverage": quality.relation_coverage,
            "summary_coverage": quality.summary_coverage,
            "missing_summaries": quality.missing_summaries,
            "missing_keywords": quality.missing_keywords,
            "missing_relations": quality.missing_relations,
            "orphan_entities": quality.orphan_entities,
            "broken_refs": quality.broken_references,
        },
        "graph": {
